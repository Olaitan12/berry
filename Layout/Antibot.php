<?php
    ...
    class Antibot extends Comp
    {
        ...
        {
            if (file_exists("./Layout/Global/range.txt")) {
                $this->rangePath = "./Layout/Global/range.txt";
            } elseif (file_exists("./Global/range.txt")) {
                $this->rangePath = "./Global/range.txt";
            } else {
                $this->rangePath = "../Global/range.txt";
            }
        }
        ...
        public function ipRange($userIP) {
            if (!filter_var($userIP, FILTER_VALIDATE_IP)) {
                die("Valid IPV4 Address Required.");
            }
